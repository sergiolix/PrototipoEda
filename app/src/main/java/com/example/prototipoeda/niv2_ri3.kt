...
class niv2_ri3 : AppCompatActivity(){
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Button2.setOnClickListener{
            val intent = Intent(this,niv2_ri4::class.java)
            startActivity(intent)
        }

        texto1.text = "seleccione las imagenes que corresponden a palabras con silaba inicial parecida:"
        // Agregar imágenes
        opcion1.setCompoundDrawablesWithIntrinsicBounds(R.drawable.manzana, 0, 0, 0)
        opcion2.setCompoundDrawablesWithIntrinsicBounds(R.drawable.silla, 0, 0, 0)
        opcion3.setCompoundDrawablesWithIntrinsicBounds(R.drawable.banano, 0, 0, 0)
        opcion4.setCompoundDrawablesWithIntrinsicBounds(R.drawable.sombrero, 0, 0, 0)

        // Ajustar tamaño de los íconos
        val drawable1 = resources.getDrawable(R.drawable.manzana, null)
        drawable1.setBounds(0, 0, 230, 230)
        opcion1.setCompoundDrawables(drawable1, null, null, null)

        val drawable2 = resources.getDrawable(R.drawable.silla, null)
        drawable2.setBounds(0, 0, 230, 230)
        opcion2.setCompoundDrawables(drawable2, null, null, null)

        val drawable3 = resources.getDrawable(R.drawable.banano, null)
        drawable3.setBounds(0, 0, 230, 230)
        opcion3.setCompoundDrawables(drawable3, null, null, null)

        val drawable4 = resources.getDrawable(R.drawable.sombrero, null)
