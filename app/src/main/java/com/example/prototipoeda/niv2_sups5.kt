...
class niv2_sups5 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.nivel2_sups)
        ...
        Button2.setOnClickListener {
            val intent = Intent(this, niv2_sups6::class.java)
            startActivity(intent)
        }
        // Asignar una imagen desde los recursos drawable
        imagen.setImageResource(R.drawable.camaron)
