...
class niv2_rf5 : AppCompatActivity(){
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Button2.setOnClickListener{
            val intent = Intent(this,niv2_rf6::class.java)
            startActivity(intent)
        }

        texto1.text = "seleccione las imagenes que corresponden a palabras con silaba final parecida:"
        // Agregar imágenes
        opcion1.setCompoundDrawablesWithIntrinsicBounds(R.drawable.casa, 0, 0, 0)
        opcion2.setCompoundDrawablesWithIntrinsicBounds(R.drawable.camion, 0, 0, 0)
        opcion3.setCompoundDrawablesWithIntrinsicBounds(R.drawable.avion, 0, 0, 0)
        opcion4.setCompoundDrawablesWithIntrinsicBounds(R.drawable.manzana, 0, 0, 0)

        // Ajustar tamaño de los íconos
        val drawable1 = resources.getDrawable(R.drawable.casa, null)
        drawable1.setBounds(0, 0, 230, 230)
        opcion1.setCompoundDrawables(drawable1, null, null, null)

        val drawable2 = resources.getDrawable(R.drawable.camion, null)
        drawable2.setBounds(0, 0, 230, 230)
        opcion2.setCompoundDrawables(drawable2, null, null, null)

        val drawable3 = resources.getDrawable(R.drawable.avion, null)
        drawable3.setBounds(0, 0, 230, 230)
        opcion3.setCompoundDrawables(drawable3, null, null, null)

        val drawable4 = resources.getDrawable(R.drawable.manzana, null)
