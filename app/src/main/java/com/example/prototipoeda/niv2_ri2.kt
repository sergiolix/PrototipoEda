...
class niv2_ri2 : AppCompatActivity(){
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Button2.setOnClickListener{
            val intent = Intent(this,niv2_ri3::class.java)
            startActivity(intent)
        }

        texto1.text = "seleccione las imagenes que corresponden a palabras con silaba inicial parecida:"
        // Agregar imágenes
        opcion1.setCompoundDrawablesWithIntrinsicBounds(R.drawable.yogurt, 0, 0, 0)
        opcion2.setCompoundDrawablesWithIntrinsicBounds(R.drawable.lapiz, 0, 0, 0)
        opcion3.setCompoundDrawablesWithIntrinsicBounds(R.drawable.lampara, 0, 0, 0)
        opcion4.setCompoundDrawablesWithIntrinsicBounds(R.drawable.camion, 0, 0, 0)

        // Ajustar tamaño de los íconos
        val drawable1 = resources.getDrawable(R.drawable.yogurt, null)
        ...
        val drawable2 = resources.getDrawable(R.drawable.lapiz, null)
        ...
        val drawable3 = resources.getDrawable(R.drawable.lampara, null)
        ...
        val drawable4 = resources.getDrawable(R.drawable.camion, null)
        ...
        Button1.setOnClickListener {
            ...
            if (selectedOptions.size == 2) {
                ...
                if (selectedOptions.contains("opc2") && selectedOptions.contains("opc3")) {
