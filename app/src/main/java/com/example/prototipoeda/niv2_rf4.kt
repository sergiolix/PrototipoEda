...
class niv2_rf4 : AppCompatActivity(){
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Button2.setOnClickListener{
            val intent = Intent(this,niv2_rf5::class.java)
            startActivity(intent)
        }

        texto1.text = "seleccione las imagenes que corresponden a palabras con silaba final parecida:"
        // Agregar imágenes
        opcion1.setCompoundDrawablesWithIntrinsicBounds(R.drawable.pato, 0, 0, 0)
        opcion2.setCompoundDrawablesWithIntrinsicBounds(R.drawable.gato, 0, 0, 0)
        opcion3.setCompoundDrawablesWithIntrinsicBounds(R.drawable.cama, 0, 0, 0)
        opcion4.setCompoundDrawablesWithIntrinsicBounds(R.drawable.maleta, 0, 0, 0)

        // Ajustar tamaño de los íconos
        val drawable1 = resources.getDrawable(R.drawable.pato, null)
        drawable1.setBounds(0, 0, 230, 230) // Ajusta el tamaño de la imagen si es necesario
        opcion1.setCompoundDrawables(drawable1, null, null, null)

        val drawable2 = resources.getDrawable(R.drawable.gato, null)
        drawable2.setBounds(0, 0, 230, 230) // Ajusta el tamaño de la imagen si es necesario
        opcion2.setCompoundDrawables(drawable2, null, null, null)

        val drawable3 = resources.getDrawable(R.drawable.cama, null)
        drawable3.setBounds(0, 0, 230, 230) // Ajusta el tamaño de la imagen si es necesario
        opcion3.setCompoundDrawables(drawable3, null, null, null)

        val drawable4 = resources.getDrawable(R.drawable.maleta, null)
        drawable4.setBounds(0, 0, 230, 230) // Ajusta el tamaño de la imagen si es necesario
        ...
        Button1.setOnClickListener {
            ...
            if (selectedOptions.size == 2) {
                ...
                if (selectedOptions.contains("opc1") && selectedOptions.contains("opc2")) {
