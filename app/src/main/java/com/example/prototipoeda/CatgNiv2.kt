...
class CatgNiv2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mostrarTutorial(this, "Silaba", "Las silabas son las unidades que se pueden dividir en palabras y contienen uno o más sonidos. Una palabra destaca del resto porque agrupa sonidos vocálicos y consonánticos que se pronuncian unidos. \n" +
                "\n" +
                "Todas las palabras son sílabas, desde las largas hasta las únicas. Cada palabra tiene un núcleo, que en español siempre es una vocal (a, e, i, o, u). Además, una palabra consonántica puede tener consonantes, es decir, letras y sonidos que se asocian a una vocal a pronunciar.", R.raw.silaba,"silaba")
