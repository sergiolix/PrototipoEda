...
class niv2_rf2 : AppCompatActivity(){
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Button2.setOnClickListener{
            val intent = Intent(this,niv2_rf3::class.java)
        ...
        opcion3.setCompoundDrawablesWithIntrinsicBounds(R.drawable.mesa, 0, 0, 0)
        opcion4.setCompoundDrawablesWithIntrinsicBounds(R.drawable.yogurt, 0, 0, 0)
        ...
        val drawable3 = resources.getDrawable(R.drawable.mesa, null)
        drawable3.setBounds(0, 0, 230, 230)
        opcion3.setCompoundDrawables(drawable3, null, null, null)

        val drawable4 = resources.getDrawable(R.drawable.yogurt, null)
        ...
        Button1.setOnClickListener {
            ...
            if (selectedOptions.size == 2) {
                ...
                if (selectedOptions.contains("opc1") && selectedOptions.contains("opc3")) {
