...
class niv2_rf3 : AppCompatActivity(){
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Button2.setOnClickListener{
            val intent = Intent(this,niv2_rf4::class.java)
            startActivity(intent)
        }

        texto1.text = "seleccione las imagenes que corresponden a palabras con silaba final parecida:"
        // Agregar imágenes
        opcion1.setCompoundDrawablesWithIntrinsicBounds(R.drawable.arbol, 0, 0, 0)
        opcion2.setCompoundDrawablesWithIntrinsicBounds(R.drawable.libro, 0, 0, 0)
        opcion3.setCompoundDrawablesWithIntrinsicBounds(R.drawable.maleta, 0, 0, 0)
        opcion4.setCompoundDrawablesWithIntrinsicBounds(R.drawable.cometa, 0, 0, 0)

        // Ajustar tamaño de los íconos
        val drawable1 = resources.getDrawable(R.drawable.arbol, null)
        ...
        val drawable2 = resources.getDrawable(R.drawable.libro, null)
        ...
        val drawable3 = resources.getDrawable(R.drawable.maleta, null)
        ...
        val drawable4 = resources.getDrawable(R.drawable.cometa, null)
