...
class niv2_ri1 : AppCompatActivity(){
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Button2.setOnClickListener{
            val intent = Intent(this,niv2_ri2::class.java)
            startActivity(intent)
        }

        texto1.text = "seleccione las imagenes que corresponden a palabras con silaba inicial parecida:"
        // Agregar imágenes
        opcion1.setCompoundDrawablesWithIntrinsicBounds(R.drawable.cama, 0, 0, 0)
        opcion2.setCompoundDrawablesWithIntrinsicBounds(R.drawable.casa, 0, 0, 0)
        opcion3.setCompoundDrawablesWithIntrinsicBounds(R.drawable.arbol, 0, 0, 0)
        opcion4.setCompoundDrawablesWithIntrinsicBounds(R.drawable.tetero, 0, 0, 0)

        // Ajustar tamaño de los íconos
        val drawable1 = resources.getDrawable(R.drawable.cama, null)
        ...
        val drawable2 = resources.getDrawable(R.drawable.casa, null)
        ...
        val drawable3 = resources.getDrawable(R.drawable.arbol, null)
        ...
        val drawable4 = resources.getDrawable(R.drawable.tetero, null)
