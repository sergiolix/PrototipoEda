...
class niv2_ri4 : AppCompatActivity(){
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Button2.setOnClickListener{
            val intent = Intent(this,niv2_ri5::class.java)
            startActivity(intent)
        }

        texto1.text = "seleccione las imagenes que corresponden a palabras con silaba inicial parecida:"
        // Agregar imágenes
        opcion1.setCompoundDrawablesWithIntrinsicBounds(R.drawable.sol, 0, 0, 0)
        opcion2.setCompoundDrawablesWithIntrinsicBounds(R.drawable.maleta, 0, 0, 0)
        ...
        val drawable1 = resources.getDrawable(R.drawable.sol, null)
        drawable1.setBounds(0, 0, 230, 230)
        opcion1.setCompoundDrawables(drawable1, null, null, null)

        val drawable2 = resources.getDrawable(R.drawable.maleta, null)
