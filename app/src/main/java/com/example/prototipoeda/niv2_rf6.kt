...
class niv2_rf6 : AppCompatActivity(){
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Agregar imágenes
        opcion1.setCompoundDrawablesWithIntrinsicBounds(R.drawable.oreja, 0, 0, 0)
        opcion2.setCompoundDrawablesWithIntrinsicBounds(R.drawable.balon, 0, 0, 0)
        opcion3.setCompoundDrawablesWithIntrinsicBounds(R.drawable.yogurt, 0, 0, 0)
        opcion4.setCompoundDrawablesWithIntrinsicBounds(R.drawable.oveja, 0, 0, 0)

        // Ajustar tamaño de los íconos
        val drawable1 = resources.getDrawable(R.drawable.oreja, null)
        drawable1.setBounds(0, 0, 230, 230)
        opcion1.setCompoundDrawables(drawable1, null, null, null)

        val drawable2 = resources.getDrawable(R.drawable.balon, null)
        drawable2.setBounds(0, 0, 230, 230)
        opcion2.setCompoundDrawables(drawable2, null, null, null)

        val drawable3 = resources.getDrawable(R.drawable.yogurt, null)
        drawable3.setBounds(0, 0, 230, 230)
        opcion3.setCompoundDrawables(drawable3, null, null, null)

        val drawable4 = resources.getDrawable(R.drawable.oveja, null)
        ...
        Button1.setOnClickListener {
            ...
            if (selectedOptions.size == 2) {
                ...
                if (selectedOptions.contains("opc1") && selectedOptions.contains("opc4")) {
